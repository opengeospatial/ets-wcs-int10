# OGC Web Coverage Service 2.0.1 Interpolation Extension Test-Suite

The OGC Web Coverage Service 2.0.1 Interpolation Extension Test-Suite provides the Executable Test Script (ETS) to test implementations against the following specification(s):
  ...
  * [WCS INT] [OGC Web Coverage Service 2.0 Interface Standard - Interpolation Extension](https://portal.opengeospatial.org/files/12-049) (OGC 12-049)
  * Compliance Test Language (CTL) 0.5


Detailed information about this test suite is available [here](http://opengeospatial.github.io/ets-wcs-int10/).
...
Issue tracker is available at [github](https://github.com/opengeospatial/ets-wcs-int10/issues).
